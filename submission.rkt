...
;    (make-ugs menu world character level objects keyboard)
...
; A keyboard is a structure:
;     (make-keyboard space left right escape)
; interpretation: (make-keyboard space left right escape) specifies which keys are currently pressed.
; this information changes how the tock and render functions work.
